...
// Using shared JwtPayload interface from `auth/shared/interfaces`
  ...
  async login(
    ...
    if (user.isTwoFactorEnabled) {
      ...
      const tempToken = await this.jwtService.signAsync(
        ...
        {
          secret: Buffer.from(this.configService.get<string>('JWT_SECRET')!, 'utf8'),
          expiresIn: '15m',
        },
      );
      this.logger.log(
