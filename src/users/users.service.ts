...
export class UsersService {
  ...
  async findByEmail(email: string) {
    // Use $queryRaw to avoid Prisma's incorrect type casting of role field
  ...
  async create(data: {
    ...
    return this.prisma.user.create({
      data: {
        ...
        role: $Enums.Role.USER, // Explicitly set role as enum
        status: $Enums.UserStatus.ACTIVE, // Explicitly set status as enum
      },
    });
  }
